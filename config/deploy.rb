...
role :web, "newGroup.com"                          # Your HTTP server, Apache/etc
role :app, "newGroup.com"                         # This may be the same as your `Web` server
role :db,  "newGroup.com"   , :primary => true # This is where Rails migrations will run
